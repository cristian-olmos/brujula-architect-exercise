package es.brujula.searcher.domain.hotel.model;
...
public final class Hotel implements Serializable {
    ...
    private Hotel(String id, String name, String address, String category) {
        this.setId(id);
        this.setName(name);
    ...
    public static Hotel create(String id, String name, String address, String category) {
        return new Hotel(id, name, address, category);
    }
